...
export default async function CategoryPage(props: {
  ...
  const faqMap: Record<string, { q: string; a: string }[]> = {
    congratulation: [
      {
        ...
        a: "축하 화환 문구는 기쁜 소식에 대한 진심 어린 축하와 앞날에 대한 좋은 기원을 담아 작성합니다. 받는 분과의 관계에 맞게 격식을 조절하세요. 리본 문구로는 '축 경하' 등을 사용합니다.",
      },
      {
        q: "축하 화환 리본 문구는 꼭 넣어야 하나요?",
        a: "필수는 아니지만, 리본 문구는 격식을 갖추는 데 도움이 됩니다. '축 경하', '축 축하' 등이 일반적으로 사용되며, 메시지와 함께 기재하는 것이 관례입니다.",
      },
      {
    ...
    condolence: [
      ...
      {
        q: "조문 화환에 사용하는 리본 문구는 무엇인가요?",
        a: "조문 화환의 리본 문구로는 '근조', '추모', '애도' 등이 일반적으로 사용됩니다. 보내는 분의 이름이나 단체명을 함께 기재합니다.",
      },
      {
    ...
    promotion: [
      ...
      {
        q: "승진/취임/영전 화환에 사용하는 리본 문구는?",
        a: "승진 화환의 리본 문구로는 '축 승진', '축 영전', '축 취임' 등을 사용합니다. 받는 분의 상황에 맞는 문구를 선택하세요.",
      },
      {
      ...
      },
      {
        ...
        a: "승진은 같은 조직 내에서 직급이 올라가는 것이고, 영전은 더 좋은 자리나 부서로 이동하는 것입니다. 취임은 새로운 직책에 부임하는 것을 말합니다. 리본 문구에 '축 승진', '축 영전', '축 취임'을 각각 상황에 맞게 사용합니다.",
      },
      {
    ...
    opening: [
      ...
      {
        q: "개업/창업 화환에 사용하는 리본 문구는 무엇인가요?",
        a: "개업 화환의 리본 문구로는 '축 개업', '축 번창', '축 신장개업' 등이 일반적입니다. 이전 개업은 '축 이전개업'을 사용합니다.",
      },
      {
    ...
    wedding: [
      ...
      {
        q: "결혼 화환에 사용하는 리본 문구는?",
        a: "결혼 화환의 리본 문구로는 '축 결혼', '축 화혼', '백년가약' 등을 사용합니다. 약혼에는 '축 약혼'을 사용합니다.",
      },
      {
    ...
    birthday: [
      ...
      {
        q: "생일/환갑/칠순 화환에 사용하는 리본 문구는?",
        a: "생일 화환의 리본 문구로는 '축 생신', '축 수연', '축 회갑', '축 고희(칠순)' 등이 사용됩니다.",
      },
      {
        q: "환갑과 칠순, 팔순의 차이는 무엇인가요?",
        a: "환갑은 만 60세, 칠순은 만 70세, 팔순은 만 80세를 뜻합니다. 각각의 리본 문구가 다르며, 환갑은 '축 회갑', 칠순은 '축 고희', 팔순은 '축 산수'를 사용합니다.",
      },
      {
      ...
      <div className="mt-12 bg-muted/30 rounded-lg p-6">
        ...
        {cat.slug === "condolence" ? (
          ...
          <div className="text-sm text-muted-foreground space-y-2">
            ...
            <p>
              리본 문구로는 &apos;축 승진&apos;, &apos;축 영전&apos;,
              &apos;축 취임&apos; 등을 사용합니다. 인사 시즌에는 수요가 급증합니다.
            </p>
          </div>
        ) : cat.slug === "opening" ? (
          <div className="text-sm text-muted-foreground space-y-2">
